	...
	<div class="container">
		<div align="center" class="navBar">
			<ul class="nav nav-pills">
				<li role="presentation"><a href="${context }/customer/list/page">我的客户列表</a></li>
				<li role="presentation" class="active"><a href="${context }/customer/list/product/page">产品列表</a></li>
			</ul>
		</div>
...
<script type="text/javascript">
	...
	function list() {
		AjaxUtil.post("/customer/list/product", {"currentPage": currentPage, "pageSize": pageSize}, function(data) {
			debug(data);
